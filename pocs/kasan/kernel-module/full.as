...
full.ko:     file format elf64-x86-64
...
00000000000002d0 <proxy>:
 ...
 2d2:	41 56                	push   r14
 2d4:	53                   	push   rbx
 2d5:	31 ff                	xor    edi,edi
 2d7:	e8 00 00 00 00       	call   2dc <proxy+0xc>
 2dc:	48 89 c3             	mov    rbx,rax
 2df:	48 83 3d 00 00 00 00 	cmp    QWORD PTR [rip+0x0],0x0        # 2e7 <proxy+0x17>
 2e6:	00 
 2e7:	74 37                	je     320 <proxy+0x50>
 2e9:	45 31 f6             	xor    r14d,r14d
 2ec:	44 8b 3d 00 00 00 00 	mov    r15d,DWORD PTR [rip+0x0]        # 2f3 <proxy+0x23>
 2f3:	4a 8d 3c fd 00 00 00 	lea    rdi,[r15*8+0x0]
 2fa:	00 
 2fb:	e8 00 00 00 00       	call   300 <proxy+0x30>
 300:	4e 8b 1c fd 00 00 00 	mov    r11,QWORD PTR [r15*8+0x0]
 307:	00 
 308:	8b 3d 00 00 00 00    	mov    edi,DWORD PTR [rip+0x0]        # 30e <proxy+0x3e>
 30e:	2e e8 00 00 00 00    	cs call 314 <proxy+0x44>
 314:	49 ff c6             	inc    r14
 317:	4c 3b 35 00 00 00 00 	cmp    r14,QWORD PTR [rip+0x0]        # 31e <proxy+0x4e>
 31e:	72 cc                	jb     2ec <proxy+0x1c>
 320:	31 ff                	xor    edi,edi
 322:	e8 00 00 00 00       	call   327 <proxy+0x57>
 327:	48 29 d8             	sub    rax,rbx
 32a:	5b                   	pop    rbx
 32b:	41 5e                	pop    r14
 32d:	41 5f                	pop    r15
 32f:	2e e9 00 00 00 00    	cs jmp 335 <proxy+0x65>
 335:	66 66 2e 0f 1f 84 00 	data16 cs nop WORD PTR [rax+rax*1+0x0]
 33c:	00 00 00 00 
